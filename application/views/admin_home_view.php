                        ...
                        <body>
                            ...
                            <div class="container">
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td style="width: 20%">Lorem IMSUM</td>
                                            <td style="width: 50%">
                                                <textarea id="textArea1" style="max-width:600px; display: none; max-height: 300px; width: 600px; height: 150px;"></textarea>
                                                <p class="edittext"> Lorem IMSUMLorem IMSUMLorem IMSUMLorem IMSUMLorem IMSUMLorem IMSUMLorem IMSUMLorem IMSUMLorem IMSUMLorem IMSUM
                                                </p>
                                            </td>
                                            <td style="width: 30%">
